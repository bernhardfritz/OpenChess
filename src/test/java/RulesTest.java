...
public class RulesTest {
	...
	public void pawnMovement() {
		...
		Movement e2_e3 = new Movement(File.E, Rank.TWO, File.E, Rank.THREE, board.getToken());
		assertTrue(Rules.isLegitMovement(board, e2_e3)); // test movement of white pawn from e2 to e3
		Movement e2_e4 = new Movement(File.E, Rank.TWO, File.E, Rank.FOUR, board.getToken());
		assertTrue(Rules.isLegitMovement(board, e2_e4)); // test movement of white pawn from e2 to e4
		Movement e2_f3 = new Movement(File.E, Rank.TWO, File.F, Rank.THREE, board.getToken());
		...
		Movement d7_d5 = new Movement(File.D, Rank.SEVEN, File.D, Rank.FIVE, board.getToken());
		...
		assertFalse(Rules.isLegitMovement(board, d7_d5)); // test movement of black pawn from d7 to d5 (black would be allowed to move after white has moved, but token is expired)
		d7_d5 = new Movement(File.D, Rank.SEVEN, File.D, Rank.FIVE, board.getToken());
		assertTrue(Rules.isLegitMovement(board, d7_d5)); // test movement of black pawn from d7 to d5 (black would be allowed to move after white has moved)
		board.addMovement(d7_d5);
		Movement e4_e3 = new Movement(File.E, Rank.FOUR, File.E, Rank.THREE, board.getToken());
		...
		Movement e4_e6 = new Movement(File.E, Rank.FOUR, File.E, Rank.SIX, board.getToken());
		...
		Movement e4xd5 = new Movement(File.E, Rank.FOUR, File.D, Rank.FIVE, board.getToken()); 
		...
		Movement e7_e5 = new Movement(File.E, Rank.SEVEN, File.E, Rank.FIVE, board.getToken());
		assertTrue(Rules.isLegitMovement(board, e7_e5)); // test movement of black pawn from e7 to e5
		board.addMovement(e7_e5);
		Movement d5xe6 = new Movement(File.D, Rank.FIVE, File.E, Rank.SIX, board.getToken());
